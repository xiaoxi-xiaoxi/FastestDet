...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', type=str,
                        default=r"C:\Users\wangyuan\Desktop\demo\detector\weight_AP05_0.840290_200-epoch.pth")
    parser.add_argument('--img', type=str, default=r"C:\Users\wangyuan\Desktop\program\dataset\gesture\HaGRID_mini\subsample\peace\00f99e94-2386-4f84-9b46-464d1a0531a2.jpg", help='The path of test image')
    ...
    while (cap.isOpened()):
        ...
        time_dura = (end - start) * 1000.
        print("forward time:%fms" % time_dura)
        ...
        cv2.imshow("Capture_Test", ori_img)
        if k == ord('q'):
            break
    cap.release()
